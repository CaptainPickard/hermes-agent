...
export const zh: Translations = {
  ...
  boot: {
    ...
    failure: {
      ...
      reinstallApp: '重新安装应用',
      bundledReinstallHint: '此应用包含 Hermes。请重新安装应用以恢复其内置运行时。',
  ...
  settings: {
    ...
    localModels: {
      ...
      pillStarts: start => `起始 ${start}`,
      pillStartsTip: '打开时的上下文窗口——已按您的硬件调整为快速运行',
      pillUpTo: max => `最高 ${max}`,
  ...
  install: {
    ...
    setupChoiceDescLocal: '将此应用连接到你已运行的 Hermes 网关，或使用这台电脑上已有的 Hermes。',
    ...
    useLocalDesc: 'Hermes 已安装在这台电脑上。立即启动 — 无需下载任何内容。',
    bundledLocalDesc: 'Hermes 随此应用一同提供。立即启动 — 无需下载任何内容。',
    bundledDamagedTitle: '使用随此应用提供的 Hermes',
    bundledDamagedDesc: '此应用包含 Hermes，但其运行时文件缺失或损坏。请重新安装 Hermes Desktop 以恢复。',
    reinstallApp: '重新安装应用',
